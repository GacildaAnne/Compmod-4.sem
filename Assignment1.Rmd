...
```{r}
# create an object with a name - make a tibble (you can also make dataframe) - writing "predictions" before rbinom() names the sample column 'predictions'
predictive_post <- tibble(predictions = rbinom(1e4, 10, prob= rnorm( 1e4, 0.743, 0.088))) %>%
