...
# Skeptic prior for model0
prior <- c(
  prior(normal(-0.3, 0.1), class = b),
...
summary(Model0)
plot(hypothesis(Model0, "DiagnosisTD < 0"))
hypothesis(Model0, "DiagnosisTD < 0")
plot(hypothesis(Model0, "DiagnosisASD < 0"))
hypothesis(Model0, "DiagnosisASD < 0")
...
prior1 <- c(
  ...
  prior(normal(-0.3, .1), class = b, coef = "DiagnosisASD:Languageus"),
  prior(normal(-0.3, .1), class = b, coef = "DiagnosisTD"),
  prior(normal(-0.3, .1), class = b, coef = "DiagnosisTD:Languageus"),
  prior(normal(-0.3, .1), class = sd),
  prior(normal(-0.3, .1), class = sigma)
)
...
summary(Model1)
plot(hypothesis(Model1, "DiagnosisTD < 0"))
hypothesis(Model1, "DiagnosisTD < 0")
plot(hypothesis(Model1, "DiagnosisASD < 0"))
hypothesis(Model1, "DiagnosisASD < 0")
...
plot(hypothesis(Model1, "DiagnosisTD:Languageus < 0"))
hypothesis(Model1, "DiagnosisTD:Languageus < 0")
plot(hypothesis(Model1, "DiagnosisASD:Languageus < 0"))
hypothesis(Model1, "DiagnosisASD:Languageus < 0")
```
```{r}
